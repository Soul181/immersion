...
<!-- ----------------------------------------------------------------------------------------------------------- -->
    ...
    <main id="js-page-content" role="main" class="page-content mt-3">
        ...
        <form id="js-edit" method="POST" action="security.php?id=<?php echo $id;?>">
            <div class="row">
                <div class="col-xl-6">
                        ...
                        <div class="panel-container">
                            ...
                            <div class="panel-content">
                                ...
                                <div class="form-group">
                                    ...
                                    <input type="password" id="userpassword" name="password_confirmation" class="form-control">
                                </div>


                                <div class="col-md-12 mt-3 d-flex flex-row-reverse">
                                    <button id="js-edit-btn" type="submit" class="btn btn-warning">Изменить</button>
                                </div>
                            </div>
                        </div>
