...
if (!isset($_SESSION['user']) && $_SESSION['user']['role'] != "admin"){ // проверка, НЕ авторизован ли админ
...
<!-- ----------------------------------------------------------------------------------------------------------- -->
					<li class="nav-item">
						...
						<span class="nav-link"><?php echo $_SESSION['user']['email'];?></span> <!-- вывод в стиле класса ссылки nav-link -->
						<?php endif; ?>
                    </li>
                    <li class="nav-item">
...
<!-- ----------------------------------------------------------------------------------------------------------- -->
    ...
    <main id="js-page-content" role="main" class="page-content mt-3">
        ...
        <form id="js-create" method="POST" enctype="multipart/form-data" action="create_user.php">
            <div class="row">
                <div class="col-xl-6">
                        ...
                        <div class="panel-container">
                            ...
                            <div class="panel-content">
                                ...
                                <div class="form-group">
                                    ...
                                    <input name="picture" type="file" id="file" class="form-control-file">
                                </div>
                            </div>
                        </div>
                                ...
                                <div class="row">
                                    <div class="col-md-4">
                                        ...
                                        <div class="input-group input-group-lg bg-white shadow-inset-2 mb-2">
                                            ...
                                            <input type="text" id="vk_link" name="vk_link" class="form-control border-left-0 bg-transparent pl-0">
                                        </div>
                                    </div>
                                    <div class="col-md-4">
                                        <!-- telegram -->
                                        <div class="input-group input-group-lg bg-white shadow-inset-2 mb-2">
                                            ...
                                            <input type="text" id="telegram_link" name="telegram_link" class="form-control border-left-0 bg-transparent pl-0">
                                        </div>
                                    </div>
                                    <div class="col-md-4">
                                        <!-- instagram -->
                                        <div class="input-group input-group-lg bg-white shadow-inset-2 mb-2">
                                            ...
                                            <input type="text" id="instagram_link" name="instagram_link" class="form-control border-left-0 bg-transparent pl-0">
                                        </div>
                                    </div>
                                    <div class="col-md-12 mt-3 d-flex flex-row-reverse">
										<button id="js-create-btn" type="submit" class="btn btn-success">Добавить</button>
                                    </div>
                                </div>
                            </div>
                        </div>
    ...
    <script>
        ...
        {
			$("#js-create-btn").click(function(event)
			{
