...
<!-- ----------------------------------------------------------------------------------------------------------- -->
				...
				<div class="col-xl-4">
                    <div id="<?php echo $user["id"];?>" class="card border shadow-0 mb-g shadow-sm-hover" data-filter-tags="<?php echo $user["user_name"];?>">
                        <div class="card-body border-faded border-top-0 border-left-0 border-right-0 rounded-top">
                            <div class="d-flex flex-row align-items-center">
                                ...
                                <div class="info-card-text flex-1">
                                    <a href="<?php echo $user["user_name"];?>" class="fs-xl text-truncate text-truncate-lg text-info" data-toggle="dropdown" aria-expanded="false">
                                        <?php echo $user["user_name"];?>
										<?php if ($_SESSION['user']['role'] == "admin" || $_SESSION['user']['email'] == $user["email"]):?>
                        ...
                        <div class="card-body p-0 collapse show">
                            <div class="p-3">
                                <a href="tel:<?php echo $user["user_phone"];?>" class="mt-1 d-block fs-sm fw-400 text-dark">
