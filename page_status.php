...
<!-- ----------------------------------------------------------------------------------------------------------- -->
    ...
    <main id="js-page-content" role="main" class="page-content mt-3">
        ...
        <form id="js-status" method="POST" action="status.php?id=<?php echo $id;?>">
            <div class="row">
                <div class="col-xl-6">
                                    ...
                                    <div class="col-md-4">
                                        ...
                                        <div class="form-group">
											...
											<select id="status" name="status" class="form-control">
                                                <?php
												$status_arr = ["success" => "Онлайн",
															   "warning" => "Отошел",
															   "danger" =>  "Не беспокоить"];
												foreach ($status_arr as $key => $value):?>
												<option <?php if ($key == $user["status"])echo "selected=".$user["status"]."\"";?> value="<?php echo $key;?>"><?php echo $value;?></option>
												<?php endforeach;?>
                                            </select>
                                        </div>
                                    </div>
                                    <div class="col-md-12 mt-3 d-flex flex-row-reverse">
                                        <button id="js-status-btn" type="submit" class="btn btn-warning">Set Status</button>
                                    </div>
                                </div>
                            </div>
                        </div>
